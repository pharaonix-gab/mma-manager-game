...
export default function MMACareer(){
  ...
  // ---- Carrière d'entraîneur : après la retraite, ouvrir sa propre salle, recruter des
  // combattants et former la nouvelle génération — jusqu'à, peut-être, produire un champion. ----
  ...
  // ---- Reconversion : Promoteur — organiser des galas, faire grandir une écurie d'événements ----
  ...
  // ---- Reconversion : Commentateur — construire une audience en commentant les grands combats ----
